...
mod tests {
    ...
    fn starter_template_catalog_lists_every_supported_template() {
        ...
        assert_eq!(templates[5].name, "java-only");
        assert_eq!(templates[6].name, "typescript-only");
    ...
    fn starter_template_catalog_marks_example_backed_templates() {
        ...
        assert_eq!(templates[5].related_example, Some("examples/java-only"));
        assert_eq!(
            templates[6].related_example,
            Some("examples/typescript-only")
        );
        assert_eq!(templates[7].related_example, Some("examples/polyglot"));
    }
}

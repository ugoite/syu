...
description: "Generated reference for docs/syu/features/cli/check.yaml"
---

> Generated from `docs/syu/features/cli/check.yaml`.
...
- **id**: FEAT-CHECK-001
  ...
  - **implementations**:
    ...
    - **yaml**:
      ...
      - **file**: docs/syu/features/cli/validation.yaml
        - **symbols**:
